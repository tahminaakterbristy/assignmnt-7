...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h6 class="text-center px-3 mt-3">${product.title}</h6>
      <p>Category: ${product.category}</p>
      <h4>Price: $ ${product.price}</h4>
      <h6>Rating: <i class="fas fa-star text-warning"></i> ${product.rating.rate}</h6>
      <p>Rated By <span class="count-color">${product.rating.count}</span> People </p>
